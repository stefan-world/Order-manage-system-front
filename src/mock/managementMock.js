...
mock.onGet('/api/partners/list').reply(200, {
  customers: [
    {
      id: '5e887a62195cc5aef7e8ca5d',
      number:1,
  ...
  products: [
    {
      ...
      number:1,
      name: 'Apple',
      avatar: '/static/images/new product/apple.jpg',
      amount: '1000Kg',
      price:2,
      saleprice:3,
      currency: '$',
    ...
    },
    {
      ...
      number:2,
      name: 'Orange',
      avatar: '/static/images/new product/orange.jpg',
      amount: '500Kg',
      price:10,
      saleprice:15,
      currency: '$',
    ...
    },
    {
      ...
      number:3,
      name: 'Pineapple',
      avatar: '/static/images/new product/pineapple.jpg',
      amount: '800kg',
      price:20,
      saleprice:30,
      currency: '$',
    ...
    },
    {
      ...
      number:4,
      name: 'Banana',
      avatar: '/static/images/new product/banana.jpg',
      amount: '1500Kg',
      price:25,
      saleprice:35,
      currency: '$',
    ...
    },
    {
      ...
      number:5,
      name: 'Potato',
      avatar: '/static/images/new product/potato.jpg',
      amount: '400kg',
      price:15,
      saleprice:20,
      currency: '$',
...
mock.onGet('/api/expenses/list').reply(200, {
  invoices: [
    {
      id: '28382843',
      number:1,
...
mock.onGet('/api/management/invoicelist').reply(200, {
  invoices: [
    {
      id: '28382843',
      currency: '$',
